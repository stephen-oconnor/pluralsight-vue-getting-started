...
const ourHeroes = [
  ...
  },
  {
    ...
    lastName: 'Papa',
    handleTheCapes: 3,
    originDate: format(new Date(2000, 8, 2), inputDateFormat),
  ...
  },
  {
    ...
    lastName: 'Papa',
    handleTheCapes: 2,
    originDate: format(new Date(2002, 9, 3), inputDateFormat),
  ...
  },
  {
    ...
    lastName: 'Papa',
    handleTheCapes: 0,
    originDate: format(new Date(2004, 10, 4), inputDateFormat),
